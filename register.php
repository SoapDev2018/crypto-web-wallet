          ...
          <div class="first">
            <form action="register.php" method="POST">
              ...
              <?php if(in_array("Email or password was incorrect<br>", $error_array))
                  echo "<span class='error_' style='color: #ff0000;'>Email or password was incorrect</span><br>"; ?>
              <?php if(in_array("Your account was not activated! A new activation email has been sent to your email<br>", $error_array))
                  echo "<span class='error_' style='color: #ff0000;'>Your account was not activated! A new activation email has been sent to your email</span><br>"; ?>
            ...
            <div class="form_body">
              <form action="register.php" method="POST">
                ...
                <?php if(in_array("Your first name should be between 2 and 32 characters long!<br>", $error_array))
                        echo "<span class='error_' style='color: #ff0000;'>Your first name should be between 2 and 32 characters long!</span><br>"; ?>
                ...
                <?php if(in_array("Your last name should be between 2 and 32 characters long!<br>", $error_array))
                        echo "<span class='error_' style='color: #ff0000;'>Your last name should be between 2 and 32 characters long!</span><br>"; ?>
                ...
                <?php if(in_array("Emails do not match!<br>", $error_array))
                        echo "<span class='error_' style='color: #ff0000;'>Emails do not match!</span><br>";
                      else if(in_array("Email is in invalid format!<br>", $error_array))
                        echo "<span class='error_' style='color: #ff0000;'>Email is in invalid format!</span><br>";
                      else if(in_array("Email already exists in database!<br>", $error_array))
                        echo "<span class='error_' style='color: #ff0000;'>Email already exists in database!</span><br>"; ?>
                ...
                <?php if(in_array("Your passwords do not match!<br>", $error_array))
                        echo "<span class='error_' style='color: #ff0000;'>Your passwords do not match!</span><br>";
                      else if (in_array("Your password should have a length between 8 and 64 characters long!<br>", $error_array))
                        echo "<span class='error_' style='color: #ff0000;'>Your password should have a length between 8 and 64 characters long!</span><br>"; ?>
